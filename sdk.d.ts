 ...
 */
export declare function importSessionToStore(
  _sessionId: string,
  _store: SessionStore,
  _options?: ImportSessionToStoreOptions,
): Promise<void>;
...
export declare type SandboxSettings = z.infer<
  ReturnType<typeof SandboxSettingsSchema>
>;
 ...
 */
export declare type TerminalReason =
  | "blocking_limit"
