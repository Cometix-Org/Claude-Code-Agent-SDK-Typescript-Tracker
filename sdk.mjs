...
var require_resolve = __commonJS((exports, module) => {
  ...
  function resolve(compile, root2, ref) {
    ...
    if (schema instanceof SchemaObject) {
      v =
        schema.validate ||
        compile.call(this, schema.schema, root2, undefined, baseId);
    } else if (schema !== undefined) {
      v = inlineRef(schema, this._opts.inlineRefs)
        ? schema
        : compile.call(this, schema, root2, undefined, baseId);
    }
    return v;
  }
      ...
      if (v2 === undefined) {
        ...
        if (localSchema) {
          v2 = resolve.inlineRef(localSchema, opts.inlineRefs)
            ? localSchema
            : compile.call(self2, localSchema, root2, localRefs, baseId2);
        }
      }
      if (v2 === undefined) {
        removeLocalRef(ref);
  ...
  function compileAsync(schema, meta, callback) {
    ...
    function _compileAsync(schemaObj) {
      ...
      function loadMissingSchema(e) {
        ...
        if (!schemaPromise) {
          schemaPromise = self2._loadingSchemas[ref] =
            self2._opts.loadSchema(ref);
...
`);
  ...
  write(data) {
    ...
    if (process.env.DEBUG_SDK) {
      process.stderr
        .write(`[ProcessTransport] Writing to stdin: ${data.substring(0, 100)}
`);
    }
    try {
          ...
          return capturedTransport === null || capturedTransport === undefined
            ...
            : capturedTransport.send({
                ...
                error: {
                  ...
                  message:
                    (_a2 = error.message) !== null && _a2 !== undefined
                      ? _a2
                      : "Internal error",
                },
              });
    ...
    const registeredPrompt = {
      ...
      argsSchema:
        argsSchema === undefined
          ? undefined
          : exports_external.object(argsSchema),
      callback,
      enabled: true,
      ...
      update: (updates) => {
        ...
        if (typeof updates.argsSchema !== "undefined")
          registeredPrompt.argsSchema = exports_external.object(
            updates.argsSchema,
          );
        if (typeof updates.callback !== "undefined")
    ...
    const registeredTool = {
      ...
      inputSchema:
        inputSchema === undefined
          ? undefined
          : exports_external.object(inputSchema),
      outputSchema:
        outputSchema === undefined
          ? undefined
          : exports_external.object(outputSchema),
      annotations,
      callback,
      enabled: true,
      ...
      update: (updates) => {
        ...
        if (typeof updates.paramsSchema !== "undefined")
          registeredTool.inputSchema = exports_external.object(
...
function query({ prompt, options }) {
  ...
  process.env.CLAUDE_AGENT_SDK_VERSION = "0.1.47";
  const {
